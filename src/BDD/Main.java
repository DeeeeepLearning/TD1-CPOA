		...
		do 
		{
			...
			if(reponseTable == 1) //abonnement
			{
				...
				else // Supprimer
				{
					...
					id = scanner.nextInt();
					Connexion.supprTable("Abonnement",id);
				}
			}
			else if(reponseTable == 2) // Client
			{
				...
				else // suppr
				{
					...
					@SuppressWarnings("resource")
					Scanner scannerClient = new Scanner(System.in);
					id = scannerClient.nextInt();
					Connexion.supprTable("Client",id);
				}
			...
			else if(reponseTable == 3 ) //periodicite
			{
				...
				else // suppr
				{
					...
					id = scannerP.nextInt();
					Connexion.supprTable("Periodicite",id);
				}
			}
